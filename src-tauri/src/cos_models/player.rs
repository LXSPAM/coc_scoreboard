...
pub mod cos_player {
    ...
    pub struct Player {
        ...
        pub exp_level: i32,
        pub trophies: i32,
        pub trophy_league_id: Option<i32>,
        pub legend_trophies: Option<i32>,
        pub war_stars: Option<i32>,
        ...
        pub best_versus_trophies: Option<i32>,
        pub info: Info,
        ...
        pub player_history_start_date: Option<String>,
        pub achievements: Vec<Achievement>,
        pub troops: Vec<Hero>,
        pub spells: Option<Vec<Hero>>,
        pub heroes: Option<Vec<Hero>>,
        pub super_troops: Vec<SuperTroop>,
        pub date_added: Option<String>,
        pub best_donations: Option<BestDonations>,
    }
